        ...
        <div className="relative">
          ...
          {showRoleMenu && (
            ...
            >
              ...
              {/* Sekolah Header */}
              <div className="px-3 pt-2 pb-1 text-[10px] font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400 border-t border-slate-100 dark:border-slate-700/60 mt-1 flex items-center gap-1.5">
                <School className="w-3 h-3" />
                <span>Mode Sekolah Terdaftar ({registeredSchools.length}):</span>
              </div>
              <div className="max-h-48 overflow-y-auto divide-y divide-slate-50 dark:divide-slate-700/30">
