...
export const DEFAULT_MASTER_JENIS_SK: MasterJenisSk[] = [
  {
    ...
    fields: [
      ...
      { fieldKey: 'nomorRekomendasiCabang', label: 'Nomor SK Rekomendasi Cabang', isRequired: false, type: 'text', placeholder: 'Nomor Surat/SK Rekomendasi Cabang', group: 'identitas' },
      { fieldKey: 'nipm', label: 'NIPM', isRequired: false, type: 'text', placeholder: 'Nomor NIPM jika ada', group: 'identitas' },
      { fieldKey: 'nuptk', label: 'NUPTK / NPK', isRequired: false, type: 'text', placeholder: 'NUPTK / NPK jika ada', group: 'identitas' },
  ...
  },
  {
    ...
    fields: [
      ...
      { fieldKey: 'nomorRekomendasiCabang', label: 'Nomor SK Rekomendasi Cabang', isRequired: false, type: 'text', placeholder: 'Nomor Surat/SK Rekomendasi Cabang', group: 'identitas' },
      { fieldKey: 'nipm', label: 'NIPM', isRequired: false, type: 'text', placeholder: 'Nomor NIPM jika ada', group: 'identitas' },
      { fieldKey: 'nuptk', label: 'NUPTK / NPK / NUKS', isRequired: false, type: 'text', placeholder: 'NUPTK / NPK / NUKS jika ada', group: 'identitas' },
      { fieldKey: 'birthPlace', label: 'Tempat Lahir', isRequired: false, type: 'text', placeholder: 'Tempat lahir', group: 'identitas' },
      { fieldKey: 'birthDate', label: 'Tanggal Lahir', isRequired: false, type: 'date', group: 'identitas' },
